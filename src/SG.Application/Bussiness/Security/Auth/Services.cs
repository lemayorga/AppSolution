...
) : IAuthService
{
    ...
    public async Task<Result<Responses.LoginResponse>> Login(LoginRequest loginModel)
    {
        ...
        {
            return Result.Fail<Auth.Responses.LoginResponse>(MESSAGE_CONSTANTS.VALIDATION_INVALID_CREDENTIALS);
        }
    ...
    public async Task<Result<Auth.Responses.LoginResponse>> RefreshToken(RefreshTokenModel model)
    {
        ...
        {
            return Result.Fail<Auth.Responses.LoginResponse>(MESSAGE_CONSTANTS.REFRESH_TOKEN_ERROR);
        }
        ...
        {
            return Result.Fail<Auth.Responses.LoginResponse>(MESSAGE_CONSTANTS.TOKEN_INVALID_OR_EXPIRED);
        }
